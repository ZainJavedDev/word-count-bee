...
Word-Count is used to count the number of words, punctuations, lines and vowels in a text file. User can specify the file path and number of goroutines used for the calculations. Built in beego MVC framework and utilizes (https://github.com/RehanAfridikkk/word-count-Echo-API)
